...
class DrugExposure(models.Model):
    drug_exposure_id = models.AutoField(primary_key=True, db_comment="Primary key of the drug exposure record")
    person = models.ForeignKey(
        Person,
        models.DO_NOTHING,
        blank=True,
...
class LinkedProvider(models.Model):
    linked_provider_id = models.AutoField(primary_key=True)
    person = models.ForeignKey(Person, models.DO_NOTHING, blank=True, null=True)
    provider = models.ForeignKey(Provider, models.DO_NOTHING, blank=True, null=True)
...
class VisitOccurrence(models.Model):
    visit_occurrence_id = models.AutoField(primary_key=True, db_comment="Primary key for the visit record")
    person = models.ForeignKey(
        Person,
        models.DO_NOTHING,
        blank=True,
